...
"""Local fallback for ``transformers.generation.beam_constraints``.

``transformers.generation.beam_constraints`` (which provided ``Constraint``,
``PhrasalConstraint``, ``DisjunctiveConstraint`` and ``ConstraintListState``) was
