...
def build_semantic_model(path_='./models/tts/maskgct/ckpt/wav2vec2bert_stats.pt', model_id="facebook/w2v-bert-2.0"):
    semantic_model = Wav2Vec2BertModel.from_pretrained(model_id)
    semantic_model.eval()
